...
public class VocalizerFragment extends Fragment implements VocalizerListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_vocalizer, container, false);
    }
    ...
    public void Vocalize(String text){
        ...
        if (TextUtils.isEmpty(text)) {
            ...
            // Set the listener.
            vocalizer.setListener(VocalizerFragment.this);
