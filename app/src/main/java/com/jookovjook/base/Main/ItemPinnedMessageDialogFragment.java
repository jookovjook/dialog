...
public class ItemPinnedMessageDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setTitle(R.string.dialog_message_item_pinned);
        ...
        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                getDataProvider().editItem(itemPosition, input.getText().toString());
                //notifyItemPinnedDialogDismissed(true);
                dialog.cancel();

                //final Fragment fragment = getFragmentManager().findFragmentByTag("list view");
    ...
    public AbstractDataProvider getDataProvider() {
        final Fragment fragment = getFragmentManager().findFragmentByTag("data provider");
