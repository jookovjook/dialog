...
package com.jookovjook.base.DraggableSwipeable;
...
import com.jookovjook.base.Main.MainActivity;
import com.jookovjook.base.R;

public class DraggableSwipeableFragment extends Fragment {
    ...
    public DraggableSwipeableFragment() {
        super();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //adapter
        final DraggableSwipeableAdapter myItemAdapter = new DraggableSwipeableAdapter(getDataProvider());
...
//        mRecyclerViewSwipeManager.setReturnToDefaultPositionAnimationDuration(2000);
    ...
    public void notifyItemsSetChanged(int position){
        mAdapter.notifyItemInserted(position);
    }
