...
import com.jookovjook.base.Utils.DrawableUtils;
import com.jookovjook.base.Utils.ViewUtils;

class DraggableSwipeableAdapter
    ...
    public void onSetSwipeBackground(MyViewHolder holder, int position, int type) {
        ...
        switch (type) {
            ...
            case Swipeable.DRAWABLE_SWIPE_LEFT_BACKGROUND:
                if(position == 0) {
                    bgRes = R.drawable.bg_swipe_item_left_top;
                }else{
            ...
            case Swipeable.DRAWABLE_SWIPE_RIGHT_BACKGROUND:
                if(position == 0) {
                    bgRes = R.drawable.bg_swipe_item_right_top;
                }else{
